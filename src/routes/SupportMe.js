  ...
  return (
    <div id='support-me'>
      ...
      <div className='content'>
        <p>If you like my work consider donating any amount to help me create more projects that bring awareness to the strengths of Bitcoin amidst a noisy and distracted world.</p>
