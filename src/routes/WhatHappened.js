  ...
  return (
    <div id='what-happened'>
      ...
      <div className='content'>
        ...
        <p>We saved in different currencies as a “safety mechanism” and one of these currencies collapsed.</p>
        <p>We still felt safe since a big part of our savings were in US dollars (the global currency).</p>

        <p>Then 2021 came, and I stopped feeling handsome.</p>

        <p>I finally learned about inflation, bitcoin, fiat, and I had to deal with one of the hardest blows in life:</p>
        <p>A big portion of my hard-earned money was taken from me with the flick of a computer button and a printer. There was no way that money is coming back.</p>
        <p>Instead of the usual noise surrounding bitcoin, I finally went into the rabbit hole of bitcoin reading hard literature.</p>
        <p>My mission now is to do everything in my power as a Software Engineer to help others learn about the power of bitcoin and how we can finally achieve individual sovereignity.</p> */}
      </div>
    </div>
  )
}
